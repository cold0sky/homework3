...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void onDurationChanged(String input) {
        ...
        if (isValid) {
            ...
            resetTargetAnimation(Integer.valueOf(input));
        } else {
    ...
    private void resetTargetAnimation(int input) {
        if (animatorSet != null) {
            animatorSet.cancel();
        }
